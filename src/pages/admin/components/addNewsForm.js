        ...
        ${Navigation.render()}
            <div class="ml-4 rounded-l-2xl relative bg-white w-full">
                ...
                <div class="w-1/2 shadow-lg p-4 ml-14 mt-4 bg-slate-100 rounded drop-shadow-lg">
                    ...
                    <input type="file" id="file" class="shadow-sm bg-gray-50 text-gray-900  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                    </div>
                    <div class="mb-6">
