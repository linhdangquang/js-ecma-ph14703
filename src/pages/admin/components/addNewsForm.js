        ...
        ${Navigation.render()}
            <div class="ml-4 rounded-l-2xl relative bg-white w-full">
                ...
                <div class="w-1/2 shadow-lg p-4 ml-14 mt-4 bg-slate-100 rounded drop-shadow-lg">
                    ...
                    <textarea type="text" id="desc" class="shadow-sm  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  h-24" required></textarea>
                    </div>
